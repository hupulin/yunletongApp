...
public class SmartRatingBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (mRatingDrawable == null && mRatingBackgroundDrawable == null) {
            mRatingDrawable = context.getResources().getDrawable(R.mipmap.star);
            mRatingBackgroundDrawable = context.getResources().getDrawable(R.drawable.transparent_bg);
        }
    }
